...
export async function createSLP(thisObject: any, name: string, tokenA: Contract, tokenB: Contract, amount: BigNumberish) {
...
export function getBigNumber(amount: BigNumberish, decimals = 18) {
